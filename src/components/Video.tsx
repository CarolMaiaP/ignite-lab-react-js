import { CaretRight, CheckCircle, DiscordLogo, FileArrowDown, Lightning } from "phosphor-react";
      ...
      <div className="p-8 max-w-[1100px] mx-auto">
        <div className="flex items-start gap-16">
          ...
          <div className="flex flex-col gap-4">
            ...
            <a href="#" className="p-4 text-sm text-blue-500 uppercase font-bold flex items-center border border-blue-500 rounded gap-2 justify-center hover:bg-blue-500 hover:text-black transition-colors">
              <Lightning size={24}/>
              Acesse o desafio
            </a>
          </div>
